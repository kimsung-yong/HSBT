...
public class TipReplyController {
    ...
    @GetMapping(value = "/pages/{t_no}/{page}", produces = {MediaType.APPLICATION_XML_VALUE, MediaType.APPLICATION_JSON_VALUE})
    public ResponseEntity<List<TipReplyVO>> getList(@PathVariable("page") int page, @PathVariable("t_no") Long t_no) {
        log.info("getList...........");
        Criteria cri = new Criteria(page, 10);
        log.info(cri);

        return new ResponseEntity<>(service.getList(cri, t_no), HttpStatus.OK);
    }
