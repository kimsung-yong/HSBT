    ...
    <%--<div class="container">
      <div class="col-lg-4 col-sm-6">
        ...
        <a class="portfolio-box" href="http://www.naver.com">
          <img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/portfolio/service/house-for-sale-2140201_640.jpg" alt="http://www.naver.com">
          <div class="portfolio-box-caption">
            &lt;%&ndash;<div class="project-category text-white-20">
              Category
            </div>&ndash;%&gt;
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 text-center">]
          <!--링크-->
          <a class="portfolio-box" href="http://www.naver.com">
            <img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/portfolio/service/house-for-sale-2140201_640.jpg">
            <div class="mt-5">
              <%--<i class="fas fa-4x fa-gem text-primary mb-4"></i>--%>
              <h3 class="h4 mb-2">회사소개</h3>
            </div>
