            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <%--                            dataTables-example--%>
                            ...
                            <div class="form-group">
                                <label>제목</label>
                                <input class="form-control" name="q_title" value="<c:out value="${qna.q_title}"/>" readonly="readonly">
                            </div>

                            <div class="form-group">
                                <label>내용</label>
                                <textarea class="form-control" name="q_content" readonly="readonly"><c:out value="${qna.q_content}"/></textarea>
                            </div>
